...
This page reproduces Figures 4B, 4C, 4D, and S11 of the manuscript interactively. The six observables can be reweighted individually or through a set of preset weightings, and the individual, structure, dynamics, and overall scores update accordingly for every XC approximation considered, with RPA/QZ used as the reference throughout.
